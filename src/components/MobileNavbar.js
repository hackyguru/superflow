...
export default function MobileNavbar() {
  return (
    <div class="w-full h-screen md:hidden sm:block">
      <section
        id="bottom-navigation"
        class="w-full block fixed inset-x-0 bottom-0 z-10 h-14 items-center pt-3 mx-4 bg-[#181B23] text-gray-300 shadow"
      >
        <div id="tabs" class="flex justify-between text-center ">
          ...
          <a class="w-full focus:text-orange-400 hover:text-orange-400 justify-center inline-block text-center pt-2 pb-1">
            <svg
              class="w-6 h-6"
              viewBox="0 0 24 24"
              fill="none"
